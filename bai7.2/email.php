...
function send_email($email_recive,$name,$contents,$subject){
  ...
  // Khai báo thư viên phpmailer
      ...
      $mail->Username   = "congminhcm1230@gmail.com"; // Tên đăng nhập tài khoản Gmail
      $mail->Password   = "congminhcm"; //Mật khẩu của gmail
      ...
      if(!$mail->Send()) {
        echo "có lỗi khi gửi email" .$mail->ErrorInfo;
        return false;
      } else {
...
$contents = '<i>i love chụt chụt</i>';
$subject = 'Ai là trùm';
send_email("congminh2012002@gmail.com","Công Minh",$contents,$subject);
?>
